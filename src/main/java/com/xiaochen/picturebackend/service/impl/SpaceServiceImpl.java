...
import com.xiaochen.picturebackend.mapper.SpaceMapper;
...
* @createDate 2026-01-04 17:58:45
*/
@Service
public class SpaceServiceImpl extends ServiceImpl<SpaceMapper, Space>
    ...
    public LambdaQueryWrapper<Space> getQueryWrapper(SpaceQueryRequest spaceQueryRequest) {
        ...
        queryWrapper.eq(ObjUtil.isNotEmpty(id), Space::getId, id)
                ...
                .like(ObjUtil.isNotEmpty(spaceLevel), Space::getSpaceLevel, spaceLevel);
        // 排序白名单
        if (StrUtil.equalsAny(sortField, "id", "spaceName", "createTime", "updateTime", "spaceLevel", "userId")) {

            SFunction<Space, ?> col = switch (sortField) {
                case "spaceName" -> Space::getSpaceName;
                case "createTime" -> Space::getCreateTime;
                case "updateTime" -> Space::getUpdateTime;
                case "spaceLevel" -> Space::getSpaceLevel;
                case "userId" -> Space::getUserId;
                default -> Space::getId;
            };
